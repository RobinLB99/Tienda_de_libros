...
// node_modules/datatables.net-colreorder-bs5/js/colReorder.bootstrap5.mjs
...
$.fn.dataTableExt.oApi.fnColReorder = function(oSettings, iFrom, iTo, drop, invalidateRows) {
  ...
  $.each(oSettings.aLastSort, function(i2, val) {
    oSettings.aLastSort[i2].src = aiInvertMapping[val.src];
  });
  for (i = 0, iLen = iCols; i < iLen; i++) {
    oCol = oSettings.aoColumns[i];
  ...
  if (invalidateRows || invalidateRows === void 0) {
  ...
  */
  ...
  "_fnConstruct": function() {
      ...
      if (!that.s.dt._bInitComplete) {
        ...
        $(table).on("draw.dt.colReorder", function() {
          if (!that.s.dt._bInitComplete && !bDone) {
            bDone = true;
            var resort2 = fnInvertKeyValues(aiOrder);
            that._fnOrderColumns.call(that, resort2);
          }
        });
      } else {
    ...
    $(table).on("destroy.dt.colReorder", function() {
      ...
      $.each(that.s.dt.aoColumns, function(i2, column) {
  ...
  "_fnMouseDown": function(e, nTh) {
    ...
    $(document).on("mousemove.ColReorder touchmove.ColReorder", function(e2) {
      that._fnMouseMove.call(that, e2);
    }).on("mouseup.ColReorder touchend.ColReorder", function(e2) {
      that._fnMouseUp.call(that, e2);
    });
  },
  /**
  ...
  "_fnMouseMove": function(e) {
    ...
    var targetsPrev = function(i2) {
      while (i2 >= 0) {
        i2--;
        if (i2 <= 0) {
          return null;
        }
        if (that.s.aoTargets[i2 + 1].x !== that.s.aoTargets[i2].x) {
          return that.s.aoTargets[i2];
        }
      }
    };
    var firstNotHidden = function() {
      for (var i2 = 0; i2 < that.s.aoTargets.length - 1; i2++) {
        if (that.s.aoTargets[i2].x !== that.s.aoTargets[i2 + 1].x) {
          return that.s.aoTargets[i2];
        }
      }
    };
    var lastNotHidden = function() {
      for (var i2 = that.s.aoTargets.length - 1; i2 > 0; i2--) {
        if (that.s.aoTargets[i2].x !== that.s.aoTargets[i2 - 1].x) {
          return that.s.aoTargets[i2];
        }
      }
  ...
  "_fnRegions": function() {
    ...
    var aoColumnBounds = [];
    $.each(aoColumns, function(i2, column) {
  ...
  "_fnCreateDragNode": function() {
    ...
    this.dom.drag = $(origTable.cloneNode(false)).addClass("DTCR_clonedTable").append(
...
$(document).on("preInit.dt.colReorder", function(e, settings) {
  ...
  var defaults = jquery_dataTables_default.defaults.colReorder;
  if (init || defaults) {
...
// node_modules/datatables.net-colreorder-bs5/js/colReorder.bootstrap5.mjs
var colReorder_bootstrap5_default = dataTables_bootstrap5_default;
export {
  colReorder_bootstrap5_default as default
};
...
datatables.net-colreorder-bs5/js/colReorder.bootstrap5.mjs:
  (*! Bootstrap 5 styling wrapper for ColReorder
   * © SpryMedia Ltd - datatables.net/license
   *)
*/
//# sourceMappingURL=datatables__net-colreorder-bs5.js.map
