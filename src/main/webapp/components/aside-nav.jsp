...
<nav class="text-light d-flex flex-column pb-2 z-1">
    ...
    <div
        class="d-flex flex-row gap-3 align-items-center contenedor-usuario mt-2 p-3"
    >
        <i class="fontawesome fa-solid fa-circle-user"></i>
        <img
            src="/assets/circulo-de-usuario-e0dd8eec.svg"
            alt="user-icon"
            hidden
        />
